...
const objectState_1 = require("@app/middleware/objectState");
const messages_1 = require("@app/actions/messages");
class BiDirAB extends React.Component {
    render() {
        const { stateObject, definition, } = this.props;
        const dir = stateObject ? stateObject.dir : undefined;
        return (React.createElement("g", { className: 'bi-dir-AB', transform: 'translate(' + definition.SVDData.x + ',' + definition.SVDData.y + ')' },
...
const mapDispatchToProps = (dispatch) => {
    return {
        onChangeDir: (id, dir) => messages_1.changeABDir(dispatch, id, dir),
    };
};
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(BiDirAB);
