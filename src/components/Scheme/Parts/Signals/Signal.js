...
const routeBuilder_1 = require("@app/actions/routeBuilder");
const signalContextMenu_1 = require("@app/actions/signalContextMenu");
...
const mapStateToProps = (state, ownProps) => {
    return {
        stateObject: objectState_1.getSignalState(state, ownProps.definition.locoNetId),
