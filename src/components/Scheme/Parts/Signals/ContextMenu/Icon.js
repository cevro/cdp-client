...
class Icon extends React.Component {
    ...
    getSpec() {
        ...
        if (spec === 'last-AB') {
            return React.createElement("g", { transform: 'translate(0,' + (this.getShieldHeight() + 35) + ')' },
                React.createElement("rect", { x: "-15", y: "-15", height: "30", width: "30", fill: "white", stroke: "black", strokeWidth: "1" }),
                React.createElement("circle", { cx: 0, cy: 0, r: 10, strokeWidth: 3, fill: "white", stroke: "black" }),
                React.createElement("circle", { cx: 0, cy: 0, r: 2, strokeWidth: 3, fill: "black", stroke: "black" }));
        }
        return null;
    }
    getStage() {
    ...
    getSmallStageLabel() {
        ...
        const width = 10;
        switch (type) {
            case signalTypes_1.signalTypes.TYPE_ENTRY:
            ...
            case signalTypes_1.signalTypes.TYPE_PATH:
            case signalTypes_1.signalTypes.TYPE_EXIT:
                return React.createElement("g", null);
            ...
            case signalTypes_1.signalTypes.TYPE_SHUNT:
                return React.createElement("g", null,
                    React.createElement("rect", { x: -width / 2, y: 0, width: width, height: 25, fill: 'white' }),
                    React.createElement("rect", { x: -width / 2, y: 25, width: width, height: 25, fill: 'blue' }));
            case signalTypes_1.signalTypes.TYPE_AB:
                return React.createElement("g", null,
