...
class SectorsPreview extends React.Component {
    render() {
        ...
        return (React.createElement("div", { className: "list-group list-scroll" }, sectors.map((sectorDef, index) => {
            ...
            return React.createElement("div", { className: 'list-group-item ' + this.getClassNameByState(state), key: index },
                React.createElement("div", { className: "row" },
                    React.createElement("span", { className: "col-2" }, sectorDef.id),
                    React.createElement("span", { className: "col-2" }, sectorDef.name),
                    React.createElement("span", { className: "col-2" }, this.getStateLabel(state)),
                    React.createElement("div", { className: "col-3" }, this.getButton(sectorDef.id, state)),
                    React.createElement("div", { className: "col-3" }, locked)));
        })));
    }
    getStateLabel(state) {
        if (state === undefined) {
            return React.createElement("span", { className: "badge badge-undefined" }, "NA");
        }
        switch (state) {
            case exports.SECTOR_STATE_OCCUPIED:
                return React.createElement("span", { className: "badge badge-danger" }, "OCCUPIED");
            case exports.SECTOR_STATE_FREE:
                return React.createElement("span", { className: "badge badge-success" }, "FREE");
            case exports.SECTOR_STATE_UNDEFINED:
                return React.createElement("span", { className: "badge badge-undefined" }, "NA");
            default:
                return React.createElement("span", { className: "badge badge-secondary" }, "WTF");
        }
    }
    getButton(id, state) {
        const buttons = [];
        if (state !== exports.SECTOR_STATE_FREE) {
        ...
        if (state !== exports.SECTOR_STATE_OCCUPIED) {
...
const mapStateToProps = (state) => {
    return {
        sectorsState: state.objectState[entity_1.ENTITY_SECTOR],
    };
};
const mapDispatchToProps = (dispatch) => {
    return {
        onChangeSector: (id, state) => messages_1.changeSector(dispatch, id, state),
    };
};
