...
const toggleSignal = (state, action) => {
    ...
    return Object.assign(Object.assign({}, state), { signals: Object.assign(Object.assign({}, state.signals), { [signalType]: status }) });
};
const togglePoints = (state) => {
    return Object.assign(Object.assign({}, state), { points: !state.points });
};
const initialState = {
    signals: {},
    points: false,
